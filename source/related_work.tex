\section{Detailed Evolution of Forecasting Methodologies}
...
\subsection{The Classical Era: From Linear to Non-linear Classics}
\label{sec:classical}
...
\subsection{The Machine Learning Transition}
\label{sec:ml}
...
\subsection{The Deep Learning Revolution: Sequential to Attention}
\label{sec:dl}
...
\subsection{The Patching Paradigm: Semantic Sub-series in Wind Signals}
\label{sec:patching}
...
\subsection{Deep Generative Models and Probabilistic Forecasting}
...
\subsection{Cross-Domain Knowledge Transfer and Pre-training}
\label{sec:transfer}
...
\subsection{Aero-elastic Coupling and Mechanical State Modeling}
...
\subsection{Spatial Modeling and Graph Neural Networks}
\label{sec:spatial}
...
\subsection{Interpretability and the Kolmogorov-Arnold Networks}
\label{sec:kan}
...
\subsection{Physics-Informed Deep Learning (PIDL)}
\label{sec:pidl}
