...
Furthermore, we observe that the learnable centers $\mu_i$ tend to cluster around periods of high information density. This unsupervised ``event alignment'' ensures that the latent tokens provided to the subsequent spatial layers are semantically rich and physically consistent, capturing the true multi-scale nature of the atmospheric signal.
