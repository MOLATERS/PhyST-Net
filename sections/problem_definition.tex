...
\begin{equation}
\begin{split}
\hat{\mathbf{Y}}_{t+1:t+H} = f_{\theta}\big(
&\mathbf{X}_{t-T+1:t}, \mathbf{E}^{h}_{t-T+1:t}, \\
&\mathbf{E}^{f}_{t+1:t+H}, A, M_G \big),
\end{split}
...
\begin{equation}
\begin{split}
\hat{\mathbf{Y}}_{t+1:t+H} = \mathcal{C}_{\Omega}\Big(
\mathcal{H}_{\theta}\big(
&\mathbf{X}_{t-T+1:t}, \mathbf{E}^{h}_{t-T+1:t}, \\
&\mathbf{E}^{f}_{t+1:t+H}, A, M_G\big) \Big),
\end{split}
...
\begin{equation}
\begin{split}
\min_{\theta}\; \frac{1}{|\mathcal{D}|} \sum_{(\mathbf{X}, \dots, \mathbf{Y})\in\mathcal{D}} \Big[ 
&\ell\big(\hat{\mathbf{Y}},\mathbf{Y}\big) \\
&+ \lambda_{\Omega}\mathcal{R}_{\Omega}\big(\hat{\mathbf{Y}},\mathbf{Y}\big) \Big],
\end{split}
