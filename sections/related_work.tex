...
\caption{Technological Timeline of Spatio-Temporal Forecasting. This timeline illustrates the transition from classical statistical foundations to the contemporary physics-aware deep learning era, highlighting pivotal architectural breakthroughs in handling domain constraints.}
\label{fig:timeline}
\end{figure}
...
\centering
\rule{0.48\textwidth}{0.16\textwidth}
\caption{Attention Maps in Modern Spatio-Temporal Transformers. This visualization demonstrates how multi-head self-attention captures long-range temporal correlations, forming the mathematical baseline for our high-capacity temporal tokens.}
