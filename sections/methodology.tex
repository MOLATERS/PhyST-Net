...
The training objective is $\mathcal{L}=\mathcal{L}_{mse}+\lambda_{\Omega}\mathcal{L}_{penalty}$. We define the feasibility penalty $\mathcal{L}_{penalty}$ to penalize violations of the operational envelope:
\begin{equation}
\mathcal{L}_{penalty} = \frac{1}{N H} \sum_{n,t} \left[ \max(0, -\hat{Y}_{n,t}) + \max(0, \hat{Y}_{n,t} - C_{dyn,n,t}) \right].
